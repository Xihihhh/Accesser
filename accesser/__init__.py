...
async def handle(reader, writer):
    ...
    with closing(writer):
        ...
        server_hostname = '' if server_hostname_key is None else host if setting.config['alter_hostname'][server_hostname_key] is False else setting.config['alter_hostname'][server_hostname_key]
        ...
        elif server_hostname_key is not None and setting.config['alter_hostname'][server_hostname_key] is not False:
